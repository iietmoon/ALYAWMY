...
class ArticlesView extends Component {
  ...
  componentDidMount() {
    return fetch('http://newsapi.org/v2/top-headlines?country=fr&category=business&apiKey=20ae5207876d4e41a85823e9d12ca0dc')
              ...
              <View>
                ...
                <View style={styles.ArtView}>
                  ...
                  <View style={styles.RightView}>
                    ...
                    <Text style={styles.ArtSrc} numberOfLines={1}>{val.source.name} • {moment.locale('fr'), moment(val.publishedAt, "YYYYMMDDhhmmss").fromNow()} </Text>
