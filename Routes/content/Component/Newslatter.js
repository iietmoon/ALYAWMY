...
import newslatter from '../../../assets/icons/newslatter.png';
     ...
     return (
          ...
          <View style={styles.TextView}>
               <TouchableHighlight onPress={() => { setModalVisible(true); }}>
                    <View style={styles.TextView}>
                         <Text style={styles.TextLink}>الأخبار عبر البريد</Text>
                         <Image source={newslatter} style={styles.TextImg} />
                    </View>
               </TouchableHighlight>
               <Modal
                    animationType="slide"
               ...
               >
                    ...
                    <View style={styles.ModalTop}>
                         ...
                         <Text style={styles.ModalTopText}>أخر الإحصائيات عن كوفيد 19</Text>
